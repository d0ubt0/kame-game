...
export default function SeleccionCartas() {
  ...
  const totalSeleccionadas = Object.values(seleccionadas).reduce((sum, val) => sum + val, 0);
  // Estado para guardar las cartas filtradas provenientes del Filtro
    ...
    <div>
      ...
      <div className="conteiner">
        <div className="conteiner-cartas">
          ...
          {/* ======== 🔍 FILTRO AÑADIDO SIN ROMPER NADA ======== */}
          ...
          <div className="conteiner-iniciar">
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              <button
                ...
                style={{
                  backgroundColor:
                    totalSeleccionadas === 10 ? "#E6C200" : "#777",
                  color: "black",
                  padding: "10px 20px",
                  borderRadius: "8px",
                  cursor:
          ...
          {cartasJugador.length === 0 ? (
            ...
            <div className="grid-cartas">
              {(busquedaActiva ? cartasFiltradas : cartasJugador)

                .map((carta) => {

                  const cantidadSeleccionada = seleccionadas[carta.id] || 0;
                  const agotada =
                    cantidadSeleccionada >= carta.cantidad;

                  return (
                    <div
                      key={carta.id}
                      onClick={() =>
                        handleSeleccion(carta.id, carta.cantidad)
                      }
                      style={{
                        border:
