  ...
  useEffect(() => {
    ...
    const fetchCollection = async () => {
      try {
        ...
        const response = await fetch(`https://incredible-creation.up.railway.app`,{headers: {"Authorization": "Bearer " + localStorage.getItem("token")?.toString() },credentials: 'include'});
